...
constructor(private http: HttpClient, private firestore: AngularFirestore) {
  ...
  getHotestGames() {
      return this.http.get<Game[]>('https://www.boardgameatlas.com/api/search?order_by=popularity&ascending=false&gt_average_user_rating=3.999&limit=9&client_id=19MjTO641U').pipe(map(res => res['games']));
  }
}
